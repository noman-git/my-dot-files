...
hl.animation({ leaf = "borderangle", enabled = true, speed = 100, bezier = "liner", style = "loop" })  -- rainbow borders / rotating colors. Speed clamped from 180: the Lua parser caps it at 100
