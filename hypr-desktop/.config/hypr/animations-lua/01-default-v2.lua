...
hl.curve("nice", { type = "bezier", points = { {0, 2.0}, {0.5, -1.0} } })  -- y clamped from 6.9 / -4.20 to the allowed [-1.00, 2.00]
...
hl.animation({ leaf = "borderangle", enabled = true, speed = 100, bezier = "linear", style = "loop" })  -- rainbow borders / rotating colors. Speed clamped from 180: the Lua parser caps it at 100
