...
# The Hyprland config is Lua now; the editable files live here.
...
main() {
    ...
    case "$choice" in
        ...
        "Edit User ENV variables") file="$lua/env.lua" ;;
        "Edit User Keybinds") file="$lua/userkeybinds.lua" ;;
        "Edit User Startup Apps (overlay)") file="$lua/startup.lua" ;;
        "Edit User Window Rules (overlay)") file="$lua/windowrules.lua" ;;
        "Edit User Settings") file="$lua/settings.lua" ;;
        "Edit User Decorations") file="$lua/decorations.lua" ;;
        "Edit User Animations") file="$lua/animations.lua" ;;
        "Edit User Laptop Settings") file="$lua/laptop.lua" ;;
        "Edit System Default Keybinds") file="$lua/keybinds.lua" ;;
        "Edit System Default Startup Apps") file="$lua/startup.lua" ;;
        "Edit System Default Window Rules") file="$lua/windowrules.lua" ;;
        "Edit System Default Settings") file="$lua/settings.lua" ;;
